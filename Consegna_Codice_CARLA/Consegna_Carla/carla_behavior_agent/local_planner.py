...
class LocalPlanner(object):
    ...
    def run_step(self, debug=False):
        ...
        # print("Self Stop Waypoint Creation: ",self._stop_waypoint_creation)
        # print("Waypoint Queue Length: ",len(self._waypoints_queue))
        # print("Min Waypoint Queue Length: ",self._min_waypoint_queue_length)
        ...
        #print("\n\n ==========IL NUMERO DI WAYPOINT RIMASTI E' ",len(self._waypoints_queue))
